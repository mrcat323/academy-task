...
Requests = {
  editStudent: function editStudent(id, name, surname, patron, email, phone, address, birthdate, courses) {
    $.ajax({
      url: Routes.editStudent,
      type: 'POST',
      headers: Routes.header,
      data: {
        id: id, name: name, surname: surname, patron: patron, email: email, phone: phone, address: address, birthdate: birthdate, courses: courses
      }
    }).done(function (data) {
  ...
  createStudent: function createStudent(name, surname, patron, email, phone, address, birthdate, courses) {
    $.ajax({
      url: Routes.createStudent,
      type: 'POST',
      headers: Routes.header,
      data: {
        name: name, surname: surname, patron: patron, email: email, phone: phone, address: address, birthdate: birthdate, courses: courses
      }
    }).done(function (data) {
  ...
  createCourse: function createCourse(title) {
    $.ajax({
  ...
  editCourse: function editCourse(id, title) {
    $.ajax({
...
$(document).on('click', '.update-student', function () {
  var id = $(this).closest('.update-form').attr('id'),
      name = $('.name').val(),
      surname = $('.surname').val(),
      patron = $('.patron').val(),
      email = $('.email').val(),
...
$(document).on('click', '.edit-course', function () {
  var id = $(this).closest('.edit-form-course').attr('id'),
      title = $('.title').val();
